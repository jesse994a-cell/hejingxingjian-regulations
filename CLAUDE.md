...
5. **目錄整潔**：主工作目錄只保留 `CLAUDE.md`、`index.html` 及 14 份 A01–K01 `.md` 文件；其他非必要檔案一律移入 `backup/` 子目錄。
...
| `和境心見社區-A01-*.md` … `和境心見社區-K01-*.md` | 14 份管理辦法（共 14 個） |
...
### index.html 全文搜尋運作原理
- 所有 14 份 MD 的全文內容已在建置時**嵌入 index.html**（`mdContents` JS 物件）
...
*最後更新：2026-04-26（v2.0 — 改採分類編號制，共 14 份文件 A01–K01）*
