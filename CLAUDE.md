...
| J02 | 生活管理 | 代收郵件領取管理辦法 | 草擬 | `和境心見社區-J02-代收郵件領取管理辦法(草擬).md` |
...
| H | 車輛與門禁 |
| I | 資訊與資安 |
| J | 溝通與住戶服務（J01）／生活管理（J02 代收郵件歸入生活管理類） |
| K | 裝修與施工 |
| L | 租售仲介（房屋租售、仲介人員管理） |
...
*最後更新：2026-04-27（v2.5 — 修正 A02 出席門檻（二分之一）、委任對象、新增重開議條款；修正 C01 永久保存（移除訴訟例外）；修正 E01 加入平面逃生動線圖；修正 F01 健身房時間（09:00）、點數月底歸零；J02 分類改為生活管理；index.html 同步全文更新）*
