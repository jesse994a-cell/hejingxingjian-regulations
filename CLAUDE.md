...
| J02 | 溝通服務 | 代收郵件領取管理辦法 | 草擬 | `和境心見社區-J02-代收郵件領取管理辦法(草擬).md` |
...
*最後更新：2026-04-27（v2.4 — 新增 G03 寵物、J02 代收郵件、L01 租售仲介三份辦法；重寫 H01 車輛門禁、K01 裝修施工；大幅更新 A01/A03/B02/C01/F01/G01；B02 加入 K01 附件三 21 項施工罰鍰；index.html 重建至 18 份文件；目錄更新至 v2.4）*
